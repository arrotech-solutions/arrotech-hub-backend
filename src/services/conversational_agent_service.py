...
"""
    ...
    def _build_order_sheet_record(
        ...
        *,
        ...
        return {
            ...
            "Customer Phone": f"'{whatsapp_phone}" if whatsapp_phone else "",
            "M-Pesa Phone": f"'{payer_phone}" if payer_phone else "",
    ...
    async def _persist_transaction_to_google_sheets(
        ...
        record = {
            ...
            "Customer Phone": f"'{payer_phone}" if payer_phone else "",
            "M-Pesa Phone": f"'{payer_phone}" if payer_phone else "",
            "WhatsApp Phone": f"'{whatsapp_phone}" if whatsapp_phone else "",
