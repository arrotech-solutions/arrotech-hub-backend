                    ...
                    "properties": {
                        ...
                        "business_config": {
                            ...
                            "properties": {
                                ...
                                "order_type": {"type": "string", "enum": [
                                     "food", "clothing", "retail", "grocery", "pharmacy", "electronics", "drinks", "agro_vet",
                                     "beauty", "home_decor", "automotive", "books", "toys", "sports", "hardware", "florist",
                                     "pets", "services", "custom", "general"
                                 ]},
